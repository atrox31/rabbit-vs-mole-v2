...
namespace GameObjects
{
    public class FarmCarrot : CarrotBase
    {
        ...
        /// </summary>
        /// <param name="parentField">Pole, na kt�rym ro�nie marchewka.</param>
        /// <returns>Zwraca true, je�li wzrost si� rozpocz��, w przeciwnym razie false.</returns>
        ...
        /// <summary>
        /// Rozpoczyna proces usuwania marchewki (animacj� zanikania).
        /// </summary>
        /// <returns>Zwraca true, je�li proces si� rozpocz��, w przeciwnym razie false.</returns>
        ...
        /// <summary>
        /// Ustawia pocz�tkow� i ko�cow� pozycj� marchewki na podstawie pola, na kt�rym si� pojawia.
        /// </summary>
        /// <param name="spawnPosition">Pozycja, w kt�rej obiekt jest tworzony.</param>
        ...
        private IEnumerator GrowthProcess(FarmField.FarmField parentField)
        {
            ...
            {
                // Wstrzymujemy wzrost, je�li pole nie ma wystarczaj�cej ilo�ci wody
