...
namespace GameSystems.Interface.script
{
    public class InterfaceElementBase : MonoBehaviour
    {
        [Header("Element References")]
        protected List<Image> _elementImages = new();
        protected List<TextMeshProUGUI> _elementTextMeshes = new();
        ...
        /// </summary>
        public virtual bool AllowAnchorModification => _allowAnchorModification;
        ...
        /// <summary>
        /// Initialize custom element with argument. Override this method in custom elements to handle initialization arguments.
        /// </summary>
        /// <param name="argument">Argument to pass to custom element for initialization</param>
        public virtual void InitializeWithArgument(object argument)
        {
        ...
        protected virtual IEnumerator AnimateCoroutine(AnimationStatus animationStatus)
        {
            ...
            List<InterfaceElement> filteredChildren = new();
