...
namespace WalkingImmersionSystem
{
    public class WalkingImmersionSystemController : MonoBehaviour
    {
        ...
        private const int PARTICLE_POOL_SIZE = 8; // this is pool for one avatar
        ...
        private bool Setup()
        {
            ...
            {
                DebugHelper.LogError(this, $"WalkingImmersionSystemController error! _particleSystemForFoots - not assign.");
                return false;
            }

            if (_rigidbody == null)
            {
                DebugHelper.LogError(this, $"WalkingImmersionSystemController error! _rigidbody - not assign.");
                return false;
            }

            if (!PrepareLayerData())
            {
                DebugHelper.LogError(this, $"WalkingImmersionSystemController error! PrepareLayerData()");
                return false;
            }
            ...
            {
                DebugHelper.LogError(this, $"WalkingImmersionSystemController error! PrepareParticlesPool()");
                return false;
            }
        ...
        private bool PrepareParticlesPool()
        {
            if (_particleSystemForFoots == null)
            {
                DebugHelper.LogError(this, "WalkingImmersionSystemController error! PrepareParticlesPool() - _particleSystemForFoots = null");
                return false;
            }
        ...
        public bool SetupTerrain()
        {
            ...
            {
                DebugHelper.LogError(this, $"WalkingImmersionSystemController error! SetupTerrain-> GetOrAddComponent<TerrainSurfaceDetector>() is null");
                return false;
            }
